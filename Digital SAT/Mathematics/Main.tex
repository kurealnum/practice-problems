...
\begin{enumerate}
	...
	\item {Marc is an aspiring music artist. He has a record contract that pays him a base rate $\$200$ a month and an additional $\$12$ for each album he sells. Last month he earned a total of $\$644$. If $a$ is the number of albums Marc sold last month, write an equation that best describes the situation.
